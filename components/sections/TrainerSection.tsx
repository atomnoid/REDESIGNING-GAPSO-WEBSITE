      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-8">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-none mb-2">
              Gowrish H B
            </h2>
            ...
            <div className="space-y-4 text-sm sm:text-base text-[#8B8C84] leading-relaxed mb-10 font-normal">
            ...
            <div className="grid grid-cols-3 gap-8 py-8 border-y border-[#252724] mb-10">
              {stats.map((s) => (
                <div key={s.label}>
                  <div className="font-bold text-4xl lg:text-5xl text-white mb-1 font-mono tracking-tight">{s.value}</div>
                  <p className="font-mono text-[9px] text-[#8B8C84] tracking-widest uppercase">{s.label}</p>
                </div>
              ))}
            </div>

            <blockquote className="pl-4 border-l-2 border-[#E44B27] text-lg font-medium text-white/95 leading-relaxed mb-8">
