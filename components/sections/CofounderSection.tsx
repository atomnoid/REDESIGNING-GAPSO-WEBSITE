      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7">
            <p className="label mb-4">The Co-Founder</p>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#111210] leading-none mb-2">
              Surya Bharadwaj
            </h2>
            ...
            <div className="space-y-4 text-sm sm:text-base text-[#6B6C65] leading-relaxed mb-10 font-normal">
          ...
          <div className="lg:col-span-5">
            <div className="aspect-[4/5] overflow-hidden bg-[#ECE8DD] border border-[#D6D3C8]">
