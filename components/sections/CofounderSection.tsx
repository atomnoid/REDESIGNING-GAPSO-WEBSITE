...
export function CofounderSection({ imageUrl }: CofounderSectionProps) {
  return (
    <section className="py-24 md:py-32 bg-white border-b border-[#E6E5E1] relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-medium tracking-tight text-[#0D0D0C] leading-none mb-2">
              Surya Bharadwaj
            </h2>
            ...
            <div className="space-y-4 text-sm sm:text-base text-[#6B6B69] font-normal leading-relaxed mb-10">
              <p>
            ...
            <div className="pt-6 border-t border-[#E6E5E1]">
              <span className="font-mono text-[10px] tracking-widest text-[#0D0D0C] uppercase font-semibold block mb-2">
                FOCUS
              </span>
              <div className="font-mono text-xs text-[#6B6B69] tracking-wider leading-relaxed">
          ...
          <div className="lg:col-span-5">
            <div className="max-w-md mx-auto lg:max-w-none">
              <div className="relative aspect-[4/5] overflow-hidden bg-[#FAFAF9] border border-[#E6E5E1]">
                <img
                  src={imageUrl}
                  alt="Surya Bharadwaj"
